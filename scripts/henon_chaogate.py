...
from chaogatenn.maps import HenonMap
...
def argument_parser():
    parser = argparse.ArgumentParser(
        description="Runner for Chaogate logistic map."
    )

    parser.add_argument("--a", type=float, default=4, help="Henon map parameter `a`")
    parser.add_argument(
